...
if ( !class_exists( 'Envo_Multipurpose_Content_Widget_Slider' ) ) :
	...
	class Envo_Multipurpose_Content_Widget_Slider extends Envo_Multipurpose_Widget {
		...
		function widget( $args, $instance ) {
			...
			if ( envo_multipurpose_check_widget( $this->id ) || is_page_template() || is_customize_preview() || envo_multipurpose_is_preview() ) {
			?>
		...
		function widget_get_slide( $slide_setting ) {
			...
			if ( envo_multipurpose_is_preview() ) {
				$featured_image_url = envo_multipurpose_get_preview_img_src();
			} elseif ( $p ) {
