 ...
 */
define( 'ENVO_MULTIPURPOSE_VERSION', '1.0' );
...
function envo_multipurpose_theme_stylesheets() {
	...
	// Theme stylesheet.
	wp_enqueue_style( 'envo-multipurpose-stylesheet', get_stylesheet_uri(), array( 'bootstrap' ), '1.1.0' );
...
function envo_multipurpose_theme_js() {
	...
	wp_enqueue_script( 'envo-multipurpose-theme-js', get_template_directory_uri() . '/js/customscript.js', array( 'jquery' ), '1.1.0', true );
}
...
if ( !function_exists( 'envo_multipurpose_thumb_img' ) ) :
	...
	function envo_multipurpose_thumb_img( $img = 'full', $col = '', $link = true, $single = false ) {
		...
		} elseif ( envo_multipurpose_is_preview() && !has_post_thumbnail() ) {
