<?php if ( has_nav_menu( 'top_menu_left' ) || has_nav_menu( 'top_menu_right' ) || envo_multipurpose_is_preview() ) : ?>
	<div class="top-menu" >
			...
			<div class="container">   
				...
				<div class="collapse navbar-collapse navbar-2-collapse">
					...
					if ( envo_multipurpose_is_preview() ) {
						echo '<div class="top-left-menu-container"><ul id="top_menu_left" class="nav navbar-nav navbar-left">';
						envo_multipurpose_preview_navigation();
						echo '</ul></div>';
					} else {
						wp_nav_menu( array(
					...
					if ( envo_multipurpose_is_preview() ) {
						echo '<div class="top-right-menu-container"><ul id="top_menu_right" class="nav navbar-nav navbar-right">';
						envo_multipurpose_social_navigation();
						echo '</ul></div>';
					} else {
						wp_nav_menu( array(
...
<div class="main-menu">
	<nav id="site-navigation" class="navbar navbar-default">     
		<div class="container">   
			...
			<?php
			if ( envo_multipurpose_is_preview() ) {
				echo '<div class="menu-container"><ul id="main-menu" class="nav navbar-nav navbar-center">';
				envo_multipurpose_preview_navigation();
				echo '</ul></div>';
			} else {
				wp_nav_menu( array(
